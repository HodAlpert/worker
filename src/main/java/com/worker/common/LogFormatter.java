...
public class LogFormatter extends Formatter
{
    ...
    public String format(LogRecord record)
    {
        ...
        else if (record.getLevel().getName().equals(Level.CONFIG.getName()))
            builder.append(ANSI_CYAN);
        else if (record.getLevel().getName().equals(Level.INFO.getName()))
            builder.append(ANSI_WHITE);
        else if (record.getLevel().getName().equals(Level.FINE.getName()))
